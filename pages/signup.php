            ...
            <div class="col-12 col-md-9 col-lg-7 col-xl-6">
              <div class="card bg-white text-dark" style="border-radius: 15px;">
                <div class="card-body p-5">
                  ...
                  <?php }?>
                  <form  method="POST" id="signUp" action="<?php echo $_SERVER['REQUEST_URI'];?>">
                    ...
                    <p class="text-center mt-4 mb-0">Have already an account? <a href="login.php" class="fw-bold "><u>Login here</u></a></p>
                  </form>
